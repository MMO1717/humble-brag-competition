...
deliverables/v7_generalized_offline_check_report.md
```

## 12. v7 generalized 分支说明

`v7 generalized` 的目标不是追 public dev 最高分，而是在本地小模型 pipeline 上接入更稳健的通用社会语用模块：
...
- 中文实施报告保存在 `deliverables/v7_generalized_implementation_report.md`。
