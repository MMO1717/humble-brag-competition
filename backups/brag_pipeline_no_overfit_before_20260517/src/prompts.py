...
Examples:
Post: "I do not mean to brag but I ate vegetables three days in a row."
Label: self_aware_brag
Post: "Also, screen reading is slower, so my score is especially impressive."
Label: understated_flex
Post: "True gaming skill is finishing missions while playing another game."
