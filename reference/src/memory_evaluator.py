...
def write_memory_eval_record(
    *,
    ...
    """记录本次 run 的 memory 策略和评分，便于人工做 ablation 对比。"""
    ...
    record = {
        ...
        "memory_target_skills": manifest.get("memory_target_skills"),
        ...
        "prompt_char_count": manifest.get("prompt_char_count"),
        "submission_path": manifest.get("submission_path"),
        "debug_trace_path": manifest.get("debug_trace_path"),
    }
