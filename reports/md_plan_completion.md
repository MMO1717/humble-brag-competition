...
|---|---|---|
| Re-run complete dev and update results | `outputs/dev_20260622_174046_gemma3_12b/dev_eval_report.json`; latest full dev score is `81.475` | Done |
...
| Understanding field template repair | `src/understanding_templates.py`; `desired_feedback` repair enabled; full dev improves desired-feedback F1 `0.1511 -> 0.2112` and proxy score `81.402 -> 81.475` | Done |
